...
function openProductModal(id, originEl) {
    ...
    productModalContent.innerHTML =
        ...
        + '<div class="pm-markets" data-product-id="' + _escapeAttr(p.id) + '">'
        + '<a href="' + BEE_MARKET_LINKS.amazon + '" target="_blank" rel="noopener noreferrer" class="pm-market-link" data-market="amazon" data-product-id="' + _escapeAttr(p.id) + '"><img src="/images/icons/amazon.svg" alt="Amazon" width="24" height="24" onerror="this.style.display=\'none\'"><div><strong>Amazon</strong><br><small>Checkout prático</small></div></a>'
        + '<a href="' + BEE_MARKET_LINKS.shopee + '" target="_blank" rel="noopener noreferrer" class="pm-market-link" data-market="shopee" data-product-id="' + _escapeAttr(p.id) + '"><img src="/images/icons/shopee.svg" alt="Shopee" width="24" height="24" onerror="this.style.display=\'none\'"><div><strong>Shopee</strong><br><small>Ofertas e cupons</small></div></a>'
        + '<a href="' + BEE_MARKET_LINKS.mercadolivre + '" target="_blank" rel="noopener noreferrer" class="pm-market-link" data-market="mercadolivre" data-product-id="' + _escapeAttr(p.id) + '"><img src="/images/icons/mercadolivre.svg" alt="Mercado Livre" width="24" height="24" onerror="this.style.display=\'none\'"><div><strong>Mercado Livre</strong><br><small>Compra segura</small></div></a>'
        + '</div>'
        + '</div>'
        + '</div>';
